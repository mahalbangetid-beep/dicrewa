...
[WA] Baileys.default type: function
[WA] Baileys module loaded successfully
[WA] Found 0 session folder(s) on disk
prisma:error
Invalid `prisma.device.findMany()` invocation:
The table `main.Device` does not exist in the current database.
/app/node_modules/@prisma/client/runtime/library.js:121
